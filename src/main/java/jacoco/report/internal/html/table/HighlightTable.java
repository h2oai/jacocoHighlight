    ...
    private static class Column {
        ...
        void body(final HTMLElement tr, final int idx, final ITableItem item,
            ...
            if (visible) {
                ...
                if (!(node instanceof IBundleCoverage || node instanceof ISourceFileCoverage || node instanceof IClassCoverage || node instanceof IMethodCoverage || node instanceof IPackageCoverage)) {
