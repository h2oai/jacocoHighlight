...
class GroupName {
    ...
    public GroupName(final NameString name) {
        _name = name;
        _defined = name != null;
    }
    public GroupName() { this(null); }
    public boolean defined() { return _defined; }
    public NameString getGroupName() { return _name; }

    public boolean matches(String groupName) {
        return defined() && _name.matches(groupName);
    }
...
class BundleName {
    ...
    public BundleName(final NameString name) {
        _name = name;
        _defined = name != null;
    }
    public BundleName() { this(null); }
    public boolean defined() { return _defined; }
    public NameString getBundleName() { return _name; }

    public boolean matches(String bundleName) {
        return defined() && _name.matches(bundleName);
    }
